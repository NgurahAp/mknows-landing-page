      ...
      <section className="pb-16 pt-7 min-h-[100vh]">
        <div className="container mx-auto">
          <div className="flex flex-wrap justify-center">
            {/* Card */}
            <div className="max-w-sm bg-[#D8EFD3] w-full md:mx-8 mx-14 my-3 h-[460px] border md:my-10 relative flex flex-col">
              <Image
              ...
              <div className="p-5 -mt-20 flex flex-col flex-grow">
                <div>
                  ...
                  <p className=" text-sm  font-base">
                    Bootcamp intensif yang akan membekali peserta dengan
                    keterampilan dan pengetahuan yang dibutuhkan untuk menjadi
                    profesional di bidang front-end developer. Peserta akan
                    mempelajari HTML, CSS, dan JavaScript, serta keterampilan
                    dan konsep penting lainnya. Peserta juga akan memiliki
                    kesempatan untuk membangun portofolio yang akan membantu
                    peserta mendapatkan pekerjaan.
                  </p>
                </div>
