  ...
  return (
    <section className="md:h-[320px] h-[330px]  justify-center">
      <div className="text-center md:py-[54px] py-10">
        <h1 className="font-semibold md:text-4xl text-2xl leading-[38.4px]">
          Some count that matters
        </h1>
        <p className="md:leading-[38.4px] md:text-[16px] px-6 text-base">
      ...
      <div className="flex justify-between items-center text-center">
        <div className="flex-1 p-4">
          ...
          <p className="text-[#868A92] pt-1 text-xs md:text-xl">Dari berbagai klien</p>
        </div>
        <div className="relative flex-1 p-4">
          ...
          <p className="text-[#868A92] pt-1 text-xs md:text-xl">Instruktur Ternama</p>
        </div>
        <div className="flex-1 p-4">
